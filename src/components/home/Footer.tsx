        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/cookies" className="text-sm text-invitopia-600 hover:text-invitopia-800">{t('home.footer.cookies')}</Link></li>
              <li><Link to="/compliance" className="text-sm text-invitopia-600 hover:text-invitopia-800">{t('home.footer.compliance')}</Link></li>
            </ul>
          </div>
        </div>
