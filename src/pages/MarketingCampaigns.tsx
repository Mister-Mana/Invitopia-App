                      ...
                      <TabsContent value="audience" className="space-y-4">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {selectedCampaign.targetAudience.ageRange || 'Non défini'}
                            </p>
                          </div>
                          <div>
                            <Label>Localisation</Label>
                            <p className="text-sm text-muted-foreground">
                              {selectedCampaign.targetAudience.location || 'Non définie'}
                            </p>
                          </div>
                          <div>
                            <Label>Centres d'intérêt</Label>
                            <div className="flex flex-wrap gap-2 mt-1">
                              {selectedCampaign.targetAudience.interests.map((interest, index) => (
                                <Badge key={index} variant="outline">
                                  {interest}
                                </Badge>
                              ))}
                              {selectedCampaign.targetAudience.interests.length === 0 && (
                            ...
                            <div className="space-y-3">
                              <div>
                                ...
                                <p className="text-sm font-medium">
                                  {selectedCampaign.adContent.title || 'Titre non défini'}
                                </p>
                              </div>
                              <div>
                                <Label>Description</Label>
                                <p className="text-sm text-muted-foreground">
                                  {selectedCampaign.adContent.description || 'Description non définie'}
                                </p>
                              </div>
                              <div>
                                <Label>Image</Label>
                                {selectedCampaign.adContent.image ? (
                                  <img 
                                    src={selectedCampaign.adContent.image} 
                                    alt="Ad creative"
