...
const EventDetailsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (foundEvent) {
      ...
      // Generate QR code
      const eventUrl = `${window.location.origin}/rsvp/${eventId}`;
  ...
  const shareEvent = () => {
    const eventUrl = `${window.location.origin}/rsvp/${event.id}`;
        ...
        <Tabs defaultValue="overview" className="w-full">
              ...
              <CardContent>
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="outline" asChild>
                    <Link to={`/rsvp/${event.id}`} target="_blank">
          ...
          <TabsContent value="analytics">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">Tableaux de bord analytiques à venir...</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
